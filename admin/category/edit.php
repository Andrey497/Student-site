...
<body>
    ...
    <div class="container">
        <form class="row justify-content-center" method="post" action="edit.php" >
            <div class="mb-3 col-12 col-md-4 p-4">
                <label for="formGroupExampleInput">Название категории</label>
                <input name="name" type="text" value="<?php echo $name ?>" class="form-control" placeholder="Название">
                <div class="w-100" style="height:20px;"></div>
                <button name="btn_edit" type="submit" style="margin-right:20px;" class="btn btn-primary"> Обновить категорию</button>
