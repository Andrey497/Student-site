    ...
    <p></p>
        <div class=" content row">
            ...
            <div class=" col-sm-12 col-md-10 col-lg-10 ">
                <h2 class="content-name"> Управление сатьями </h2>

                <div class="row content-heading ">
                    <div class=" col-md-1 col-sm-1 text-left ">Id</div>
                    <div class=" col-md-3 col-sm-4  text-left ">Название</div >
                    <div class="col-md-2 col-sm-3  text-left  " >Категория</div>
                    <div class="col-md-2 col-sm-2  text-left ">Дата создания</div>
                    <div class="col-md-2 col-sm-2  text-left ">Управление</div>
                    
                </div>
                <?php foreach($arrayArticlesbyAdmin as $key => $value):?>
                <div class="row content-elem">
                    <div class=" col-md-1 col-sm-1 text-left "><?php echo $key+1?></div>
                    <div class=" col-md-3 col-sm-4  text-left "><?php echo $value['titel']?></div >
                    <div class="col-md-2 col-sm-3  text-left  " ><?php echo $value['name']?></div>
                    <div class="col-md-2 col-sm-2  text-left "><?php echo $value['CreatedTime']?></div>
                ...
                <?php endforeach?>
                <div class="row">
                    <div class="  p-4 "> <a class="btn btn-info"  href="create.php"> Добавить статью</a></div>
