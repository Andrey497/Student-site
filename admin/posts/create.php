...
<head>
    ...
    <script type="text/javascript" src="../../assets/js/ckeditor"></script>
    ...
    <div class="container">
        <form class="row justify-content-center" method="post" action="create.php" enctype="multipart/form-data">
            <div class="mb-3 col-12 col-md-12 p-4">
                ...
                <input name="namePost" type="text" class="form-control" placeholder="Название">
                ...
                <div class="w-100" style="height:20px;"></div>
                Картинка для статьи <input name="img" type="file" class="form-control">
                <div class="w-100" style="height:20px;"></div>
                <button name="btn_reg_p" type="submit" style="margin-right:20px;" class="btn btn-primary"> Создать статью</button>
